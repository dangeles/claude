...
description: Use when coordinating handoffs between workflows (e.g., skill-editor to programming-pm). Provides the universal handoff schema, validation rules, and workflow discovery conventions.
